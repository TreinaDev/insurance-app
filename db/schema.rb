...
ActiveRecord::Schema[7.0].define(version: 2022_11_21_205106) do
  ...
  create_table "coverage_pricings", force: :cascade do |t|
    ...
    t.index ["package_coverage_id", "package_id"], name: "index_coverage_pricings_on_package_coverage_id_and_package_id", unique: true
  ...
  create_table "package_coverages", force: :cascade do |t|
    ...
    t.integer "status", default: 0
    t.string "code"
    t.index ["code"], name: "index_package_coverages_on_code", unique: true
  ...
  create_table "policies", force: :cascade do |t|
    ...
    t.index ["package_id"], name: "index_policies_on_package_id"
  end
  ...
  create_table "service_pricings", force: :cascade do |t|
    ...
    t.index ["service_id", "package_id"], name: "index_service_pricings_on_service_id_and_package_id", unique: true
  ...
  add_foreign_key "policies", "packages"
