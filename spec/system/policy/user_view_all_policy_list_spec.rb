...
describe 'Administrador vê lista de todas as apólices ' do
  it 'com sucesso' do
...
describe 'Funcionário vê lista de todas as apólices da sua seguradora ' do
  it 'com sucesso' do
    ...
    Policy.create!(client_name: 'Caio Alves', client_registration_number: '11150033340',
    ...
    expect(page).to have_content 'Bruna Alves'
    expect(page).to have_content 'DEF1234567'
    expect(page).to have_content 'Caio Alves'
