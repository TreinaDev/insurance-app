...
describe 'Administrador vê lista de apólices canceladas' do
  it 'com sucesso' do
...
describe 'Funcionário vê lista de apólices canceladas' do
  it 'com sucesso' do
    ...
    Policy.create(client_name: 'Renato Alves', client_registration_number: '00050033340',
                  ...
                  equipment_id: 1, purchase_date: Time.zone.today,
                  policy_period: 12, package_id: package2.id, status: :canceled)
  ...
  it 'e não há apólices canceladas cadastradas' do
