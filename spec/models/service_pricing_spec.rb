  ...
  describe '#valid?' do
    context 'presença' do
      it 'verdadeiro para informação completa' do
        ...
        sp = ServicePricing.new(status: :active, percentage_price: 0.2, pending_package_id: pending_package1.id,
                                service: service1)
      ...
      it 'falso se pacote nulo' do
        service1 = Service.create!(name: 'Assinatura TV',
                                   description: 'Consede 10% de desconto em
                                    assinatura com mais canais disponíveis no mercado.')
        sp = ServicePricing.new(status: :active, percentage_price: 0.2, pending_package_id: nil, service: service1)
      ...
      it 'falso se status nulo' do
        ...
        pending_package1 = PendingPackage.create!(name: 'Seguro Completo', max_period: 12, min_period: 3,
                                                  insurance_company: isurance_company1,
                                                  product_category_id: product_category.id)
        sp = ServicePricing.new(status: nil, percentage_price: 0.2, pending_package_id: pending_package1.id,
                                service: service1)
      ...
      it 'falso se preço percentual vazio' do
        ...
        pending_package1 = PendingPackage.create!(name: 'Seguro Completo', max_period: 12, min_period: 3,
                                                  insurance_company: isurance_company1,
                                                  product_category_id: product_category.id)
        sp = ServicePricing.new(status: :active, percentage_price: '', pending_package_id: pending_package1.id,
                                service: service1)
    ...
    context '#numericality' do
      ...
      it 'falso quando preço percentual é maior que 30' do
        ...
        pending_package1 = PendingPackage.create!(name: 'Seguro Completo', max_period: 12, min_period: 3,
                                                  insurance_company: isurance_company1,
                                                  product_category_id: product_category.id)
        sp = ServicePricing.new(status: :active, percentage_price: 30.1, pending_package_id: pending_package1.id,
                                service: service1)
